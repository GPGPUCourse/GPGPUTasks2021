...
int main(int argc, char **argv)
{
...

    {
        ...
        for (int iter = 0; iter < benchmarkingIters; ++iter) {
            ...
            unsigned int workSizeX = (K + groupSizeX - 1) / groupSizeX * groupSizeX;
            ...
            matrix_transpose_kernel.exec(gpu::WorkSize(groupSizeX, groupSizeY, workSizeX, workSizeY), as_gpu, as_t_gpu, M, K);
