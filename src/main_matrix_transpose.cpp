...
int main(int argc, char **argv)
{
...

    {
        ...
        for (int iter = 0; iter < benchmarkingIters; ++iter) {
            // TODO
            unsigned int group_size_x = 16;
            unsigned int group_size_y = 16;

            unsigned int work_size_x = (M + group_size_x - 1) / group_size_x * group_size_y;
            unsigned int work_size_y = (K + group_size_x - 1) / group_size_x * group_size_y;
            ...
            matrix_transpose_kernel.exec(gpu::WorkSize(group_size_x, group_size_y, work_size_x, work_size_y), as_gpu, as_t_gpu, M, K);
