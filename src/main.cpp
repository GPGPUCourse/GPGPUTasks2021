...
int main()
{
    ...
    for (int platformIndex = 0; platformIndex < platformsCount; ++platformIndex) {
        ...
        /*
         * Вызов `OCL_SAFE_CALL(clGetPlatformInfo(platform, 239, 0, nullptr, &platformNameSize));` влечет ошибку -30 (CL_INVALID_VALUE).
         * В документации написано "...clGetPlatformInfo returns CL_INVALID_VALUE if param_name is not one of the supported values
         * or if size in bytes specified by param_value_size is less than size of return type and param_value is not a NULL value."
         */
        ...
        for (int deviceIndex = 0; deviceIndex < devicesCount; ++deviceIndex) {
            ...
            std::cout << "        Global memory size: " << deviceGlobalMemSize / (1 << 20) << "M" << std::endl;
            ...
            std::cout << "        Global memory cache size: " << deviceMemCacheSize / (1 << 10) << "K" << std::endl;
