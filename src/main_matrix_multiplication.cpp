...
int main(int argc, char **argv)
{
...

    {
        ...
        for (int iter = 0; iter < benchmarkingIters; ++iter) {
            ...
            unsigned int workSizeX = (N + groupSizeX - 1) / groupSizeX * groupSizeX;
            unsigned int workSizeY = (M + groupSizeY - 1) / groupSizeY * groupSizeY;
            matrix_multiplication_kernel.exec(gpu::WorkSize(groupSizeX, groupSizeY, workSizeX, workSizeY), as_gpu, bs_gpu, cs_gpu, M, K, N);
