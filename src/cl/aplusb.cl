...
__kernel void aplusb(__global const float * as, __global const float * bs, __global float * cs, unsigned int arrSize)
{
    ...
    const unsigned int arrInd = get_global_id(0);
